...
// external URL, tags). Used by the map's edit panel (with autosave-on-blur)
// and by the /review queue's full edit form — both call this imperatively
// and clear needs_review on every save.
